    ...
    return (
        <React.Fragment>
            <div>
                ...
                <input type='text' name='first' placeholder='First Name' onInput={e => setInput(e.target.value)} onChange={handleChange} />
                <input type='text' name='last' placeholder='Last Name' onInput={e => setInput(e.target.value)} onChange={handleChange} />
